...
<html lang="en">
 <head>
    ...
    <title>HSTU R M S | Admin register</title>
 ...
 if(isset($_POST['submit']))
    {
        ...
        $password = $_POST['password'];
       	  ...
       	  $insertion = "INSERT INTO admin (email,password) values ('$username','$password')";
          ...
          if($run)
          {
            ...
            <script>
              ...
              window.location.href='http://localhost/fp/admin/admin_login.php';
            </script>
            ";
          }

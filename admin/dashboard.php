  ...
  <nav class="navbar navbar-inverse navbar-fixed-top " role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav side-nav">
        <!-- FOR ADMIN  -->
                <li><a href="">Dashboard<span style="font-size:17px;" class=""></span></a></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu" style="background-color:#384f66;">
            <li><a href=""><span class=""><i class=""></i></span>Student's Info</a></li>
            <li><a href=""><span class=""></span>Teacher's Info</a></li>
            <li><a href=""><span class=""></i></span>Subject's Info</a></li>
        ...
        <li class="dropdown">
         ...
         <ul class="dropdown-menu forAnimate" role="menu" style="background-color:#384f66;">
           <li><a href=""><span class=""><i style="font-size:17px;" class=""></i></span>Assign Student</a></li>
           <li><a href=""><span class=""><i style="font-size:17px;" class=""></i></span>Assign Subject</a></li>
           <li><a href=""><span class=""><i style="font-size:17px;" class=""></i></span>Assign teachers</a></li>
 ...
 <ul class="nav navbar-nav navbar-right navbar-user" style="margin-right:0px;">
  <li class="dropdown user-dropdown">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
      Log IN &nbsp;<b class="caret"></b>&nbsp;&nbsp;<span style="font-size:17px;" class=""></span>
    </a>
    <ul class="dropdown-menu" >
     <li><a href="http://localhost/fp/admin/admin_login.php"><span style="font-size:17px;" class=""></span>Admin</a></li>
    <li><a href="http://localhost/fp/teacher/teacher_login.php"><span style="font-size:17px;" class=""></span>Teacher</a></li>
    <li><a href="http://localhost/fp/controller/controller_login.php"><span style="font-size:17px;" class=""></span>Controller Section</a></li>

...
<head>
    ...
    <title>HSTU R M S | Student Information</title>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav side-nav">
        ...
        <li class="dropdown">
         ...
         <ul class="dropdown-menu forAnimate" role="menu" style="background-color:#384f66;">
           <li><a href="http://localhost/fp/admin/assign_teachers.php"><span class=""><i style="font-size:17px;" class=""></i></span>Assign Teachers</a></li>
      ...
      while($row=mysqli_fetch_array($query_run))
        ...
        ?>
         ...
         <tr>
          ...
          <td style="text-align: center;"> <?php  echo $session ?></td>
          <td style="text-align: center;"> <?php  echo $dept ?></td>
          <td style="text-align: center;"> <?php  echo $faculty ?></td>
          <td style="text-align: center;"><button><a href="update_student_info.php?Update=<?php echo $sid;?>" class="btn btn-success">Edit</a></button></td>
          <td style="text-align: center;"><button><a href="delete_student_info.php?Delete=<?php echo $sid;?>" class="btn btn-danger">Delete</a></button></td>

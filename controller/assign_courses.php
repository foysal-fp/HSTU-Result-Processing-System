      ...
      <div class="col-md-6">
        ...
        <form action="assign_courses.php" method="POST">
          <div class="form-group">
            ...
            <input type="text" name="coursename"class="form-control"placeholder="i.e   Machine Learning" required>
          </div>
          <div class="form-group">
            <label>Course Code</label>
            <input type="text" name="courseid"class="form-control" placeholder="i.e   CSE-401"required>
          </div>
         <div class="form-group">
            <label>Credit</label>
            <input type="text" name="credit"class="form-control"placeholder="i.e    3" required>
          </div>
         <div class="form-group">
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $credit =$_POST['credit'];
        $levelsemster =$_POST['levelsemester'];
        $dept =$_POST['department'];
        $faculty =$_POST['faculty'];
        $insertion = "insert into course_info values('$coursename','$courseid','$credit','$levelsemster','$dept','$faculty')";
          ...
          if($run)
          {
            ...
            <script>
              ...
              window.location.href='assign_courses.php';
            </script>
            ";
          }
    }

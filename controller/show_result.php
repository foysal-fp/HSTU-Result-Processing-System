...
<?php 
    ...
    if(isset($_POST['search']))
    {
      ...
      while($row=mysqli_fetch_array($query_run))
      {
        ...
        <br>
      <h4 align="center">Course Title :<b> <?php echo $coursename  ?> </b>&emsp; Course Code : <b><?php echo $courseid ?></b> &emsp; Credit Hours : <b><?php echo $credit ?></b>&emsp;</h4>
        <br>
<?php
      ...
      <br>
          <table class="table table-bordered table-hover">
            <tr >
              ...
              <th style="text-align: center;"rowspan="4">Quiz</th>

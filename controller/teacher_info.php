...
<div id="wrapper">
  <nav class="navbar navbar-inverse navbar-fixed-top " role="navigation">
      ...
      <ul class="nav navbar-nav side-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu forAnimate" role="menu" style="background-color:#384f66;">
            ...
            <li><a href="http://localhost/fp/controller/teacher_info.php"><span class=""></span>Teacher's Info</a></li>
        ...
        <li class="dropdown">
         ...
         <ul class="dropdown-menu forAnimate" role="menu" style="background-color:#384f66;">
           <li><a href="http://localhost/fp/controller/add_students.php"><span class=""><i style="font-size:17px;" class=""></i></span>Assign Student</a></li>
    ...
    <li ><a href="">Contact<span style="font-size:17px;" class=""><i class=""></i></span></a></li>
...
<div class="container">
      <h2 align="center"> Hajee Mohammad Danesh Science and Technology University,Dinajpur-5200,Bangladeh</h2>
        <table class="table ttable-bordered table-hover" >
      <tr >

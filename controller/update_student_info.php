<?php 
  ...
  $query= "SELECT * FROM student_info WHERE sid='$Update_Record_id'";
...
<head>
    ...
    <title>HSTU R M S | Update Student Information</title>
      ...
      <div class="col-md-6">
        ...
        <form action="update_student_info.php" method="POST">
          <div class="form-group">
            ...
            <input type="text" name="studentname"class="form-control"value="<?php echo $sname; ?>" required>
          </div>
          <div class="form-group">
         ...
         <div class="form-group">
            <label>Session</label>
            <input type="text" name="session"class="form-control"value="<?php echo $session; ?>" required>
          </div>
...
<!--close main containt body-->
  ...
  include 'config.php';
       ...
       if(isset($_POST['submit']))
    {
        ...
        $insertion = "UPDATE  student_info SET studentname='$studentname',sid='$sid',session='$session',dept='$dept',faculty ='$faculty' WHERE sid=$sid";

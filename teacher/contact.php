...
<head>
    ...
    <title>HSTU R M S | Contact</title>
...
<div class="row">
  <div class="">
    <div class="" >
     <div class="col-sm-6" style="background-color:white;">
       <div class="media border p-3">
          <img src="nitu-mam2.jpg" alt="Adiba Mahjabin Nitu" class="mr-3 mt-3 rounded-circle" style="width:150px;">
      <div class="media-body">
          <h4>Adiba Mahjabin Nitu <small>-Supervisor</small></h4>
    ...
    <div class="col-sm-6" style="background-color:white;">
       <div class="media border p-3">
    <img src="emran-ali.jpg" alt="Emran Ali" class="mr-5 mt-5 rounded-circle" style="width:150px;">
    <div class="media-body">
      <h4>Emran Ali <small>-Co-Supervisor</small></h4>
...
<div class="row">
  <div class="">
    ...
    <div class="col-sm-4" style="background-color:white;">
       <div class="media border p-3">
    <img src="foysal.jpg" alt="Abu Foysal" class="mr-3 mt-3 rounded-circle" style="width:100px;">
    <div class="media-body">
      <h4>Abu Foysal Md. Parvez</h4>
      <p><pre>
        ID-1502011
        Department of Computer Science and Engineering (CSE)
        Faculty of Computer Science and Engineering
        Hajee Mohammad Danesh Science & Technology University, Dinajpur.
        E-mail: foysalfp.hstu@gmail.com
      </pre>
    </p>
    </div>
   </div>
      ...
      <div class="col-sm-4" style="background-color:white;">
       <div class="media border p-3">
<img src="emran-ali.jpg" alt="Syed Masunur Rahman" class="mr-3 mt-3 rounded-circle" style="width:100px;">
    <div class="media-body">
      <h4>Syed Masunur Rahman</h4>
      <p><pre>
        ID-1502059
        Department of Computer Science and Engineering (CSE)
        Faculty of Computer Science and Engineering
        Hajee Mohammad Danesh Science & Technology University, Dinajpur.
        E-mail: pranto@gmail.com
      </pre>
    </p>
    </div>
   </div>
    ...
    <div class="col-sm-4" style="background-color:white;">
       <div class="media border p-3">
 <img src="emran-ali.jpg" alt="Muhaiminur Rahman" class="mr-3 mt-3 rounded-circle" style="width:100px;">
    <div class="media-body">
      <h4>Muhaiminur Rahman</h4>
      <p><pre>
        Muhaiminur Rahman
        Department of Computer Science and Engineering (CSE)
        Faculty of Computer Science and Engineering
        Hajee Mohammad Danesh Science & Technology University, Dinajpur.
        E-mail: muhaiminur@gmail.com
      </pre>
    </p>    </div>
   </div>

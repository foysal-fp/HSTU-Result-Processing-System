     ...
     $query_run=mysqli_query($con,$query);
      ...
      while($row=mysqli_fetch_array($query_run))
        ...
        <tbody id="myTable">
         ...
         <td style="text-align: center;"><button><a href="update_course_info.php?Update=<?php echo $cid;?>" class="btn btn-success">Edit</a></button></td>
          <td style="text-align: center;"><button><a href="delete_course_info.php?Delete=<?php echo $cid;?>" class="btn btn-danger">Delete</a></button></td>

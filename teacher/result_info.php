      ...
      <br>
          <table class="table table-bordered table-hover">
            <tr >
              ...
              <th style="text-align: center;"colspan="4">Quiz</th>
            ...
            <tr align="center">
              ...
              <th style="text-align: center;">Avr Quiz </th>
    ...
    if(isset($_POST['search']))
    {
      ...
      while($row=mysqli_fetch_array($query_run))
      {
        ...
        <tr>
          ...
          <td style="text-align: center;"> <?php  echo $quiz1 ?></td>
          <td style="text-align: center;"> <?php  echo $quiz2 ?></td>
          <td style="text-align: center;"> <?php  echo $quiz3 ?></td>
          ...
          <td style="text-align: center;"><button><a href="update_result_info.php?Update=<?php echo $id;?>" class="btn btn-success">Edit</a></button></td>
          <td style="text-align: center;"><button><a href="delete_result_info.php?Delete=<?php echo $id;?>" class="btn btn-danger">Delete</a></button></td>

...
<html lang="en">
 <head>
    ...
    <title>HSTU R M S | Teacher login</title>
...
<body>
  ...
  <nav class="navbar navbar-inverse navbar-fixed " role="navigation">
    ...
    if(isset($_POST['login']))
    {
       ...
       $query="select* from assign_teacher where email = '$username' AND courseid = '$password' ";
          ...
          if(mysqli_num_rows($querycheck)>0)
          {
              echo "
                  <script>
                      ...
                      window.location.href='dash_teacher_log.php';
                  </script>
